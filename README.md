...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/HJnh7LeR0c)
...
```sh
npx nx serve mylogin
```

To create a production bundle:

```sh
npx nx build mylogin
```

To see all available targets to run for a project, run:

```sh
npx nx show project mylogin
```
